    ...
    if data.object == "page":
        for entry in data.entry:
            ...
            for event in messaging_events:
                ...
                if message.get('quick_reply', None) and message['quick_reply'].get('payload', None) in typeIdx:
                ...
                if message.get('postback', None) and message.get['postback'].get('payload', None) == 'quick_reply':
